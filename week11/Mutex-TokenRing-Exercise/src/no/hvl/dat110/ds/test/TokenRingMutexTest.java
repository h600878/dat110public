...
class TokenRingMutexTest {
    ...
    void test() throws InterruptedException, RemoteException {
        ...
        Assertions.assertNotEquals(1000, p1finalbal, 0);
        Assertions.assertNotEquals(1000, p2finalbal, 0);
        Assertions.assertNotEquals(1000, p3finalbal, 0);
        Assertions.assertEquals(911, p1finalbal, 0);
        Assertions.assertEquals(910, p2finalbal, 0);
        Assertions.assertEquals(908, p3finalbal, 0);
