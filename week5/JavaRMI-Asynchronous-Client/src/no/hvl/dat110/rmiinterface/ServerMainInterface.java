...
public interface ServerMainInterface extends Remote {
    ...
    String SERVER_INAME = "SInterface";
     ...
     */
    void registerClientCallbackObject(ClientCallbackInterface clientcallbackobj) throws RemoteException;

    void doOperation(int a, int b) throws RemoteException;    // The add method

    void shutdown() throws RemoteException;                    // this method is invoked remotely by client to shut the server down
